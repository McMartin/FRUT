...
Arguments parseArguments(const int argc, const char* const argv[])
{
  ...
  auto jucerFilePath = juce::String{argumentParser[1]};

  auto reprojucerFilePath = juce::String{argumentParser[2]};
...
{
  std::cerr << "warning: Jucer2Reprojucer has been deprecated.\n"
            << "warning: It won't get new features and will be removed in 2021.\n"
            << "warning: Please use the `reprojucer` mode of Jucer2CMake instead.\n";
  ...
  // Preamble
  {
    wLn("# This file was generated by Jucer2Reprojucer (deprecated in favor of "
        "Jucer2CMake) from \"",
        jucerFileName, "\"");
    wLn();
