...
function(jucer_project_files source_group_name)
  ...
  function(_FRUT_jucer_project_files_assert_x_or_dot input)
  ...
  foreach(argument IN LISTS ARGN)
    if(NOT DEFINED compile)
      ...
      _FRUT_jucer_project_files_assert_x_or_dot("${compile}")
    elseif(NOT DEFINED xcode_resource)
      set(xcode_resource "${argument}")
      _FRUT_jucer_project_files_assert_x_or_dot("${xcode_resource}")
    elseif(NOT DEFINED binary_resource)
      set(binary_resource "${argument}")
      _FRUT_jucer_project_files_assert_x_or_dot("${binary_resource}")
    else()
      set(path "${argument}")
