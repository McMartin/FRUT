...
macro(query_cmake_make_program)
  ...
  set(cmake_make_program_build_dir
    "${CMAKE_CURRENT_LIST_DIR}/test-utils/cmake_make_program/build/LinuxMakefile"
  )
...
macro(build_with_projucer_build_system)
  ...
  set(build_command
    "${CMAKE_COMMAND}" "-E" "env" "CONFIG=${configuration}" "${cmake_make_program}" "-n"
  )
...
macro(build_with_reprojucer_build_system)
  ...
  set(build_command "${CMAKE_COMMAND}" "-E" "env" "VERBOSE=1" "${cmake_make_program}")
