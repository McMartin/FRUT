...
- several ``CMakeLists.txt`` files generated from existing ``.jucer`` project files,
  ...
  - ``examples`` and ``extras`` projects from `JUCE 5.4.6`_ (in `generated/JUCE-5.4.6`_)
...
.. _JUCE 5.4.6: https://github.com/WeAreROLI/JUCE/tree/5.4.6
...
.. _generated/JUCE-5.4.6: https://github.com/McMartin/FRUT/tree/master/generated/JUCE-5.4.6
