...
- several ``CMakeLists.txt`` files generated from existing ``.jucer`` project files,
  ...
  - ``examples`` and ``extras`` projects from `JUCE 7.0.5`_ (in `generated/JUCE-7.0.5`_)
...
.. _JUCE 7.0.5: https://github.com/juce-framework/JUCE/tree/7.0.5
...
.. _generated/JUCE-7.0.5: https://github.com/McMartin/FRUT/tree/main/generated/JUCE-7.0.5
