...
- several ``CMakeLists.txt`` files generated from existing ``.jucer`` project files,
  ...
  - ``examples`` and ``extras`` projects from `JUCE 6.0.4`_ (in `generated/JUCE-6.0.4`_)
...
.. _JUCE 6.0.4: https://github.com/juce-framework/JUCE/tree/6.0.4
...
.. _generated/JUCE-6.0.4: https://github.com/McMartin/FRUT/tree/main/generated/JUCE-6.0.4
